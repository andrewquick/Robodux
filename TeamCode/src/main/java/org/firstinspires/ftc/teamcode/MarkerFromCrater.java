 ...
 */
@Autonomous(name = "MarkerFromCrater", group = "Blue")
@Disabled
public class MarkerFromCrater extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        sleep(75);
        /*
        OldDriveStraight(-2000, .5);
        sleep(75);
        GyroTurn(-130,.5);
        sleep(75);
        OldDriveStraight(-1200, .7);
        sleep(75);
