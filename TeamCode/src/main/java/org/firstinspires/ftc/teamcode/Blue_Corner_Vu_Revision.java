 ...
 */
@Autonomous(name = "Blue_Corner_Vu_Revision", group = "Red")
@Disabled
public class Blue_Corner_Vu_Revision extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if(red > blue){
            ...
            robot.jewel_arm.setPosition(arm_up);
            sleep(200);
            DriveStraight(1800+175, 0.15);//Drive Off far enough to line up with cryptobox

        }
        //If RED
        if (blue > red){
            DriveStraight(1800, 0.15);//Knock off Jewel and drive off stone
            sleep(100);
            robot.jewel_arm.setPosition(arm_up);
        }
        //If NONE
        if (blue == red){
            robot.jewel_arm.setPosition(arm_up);
            sleep(100);
            DriveStraight(1800, .15);//Drive Off
        }
        sleep(100);
        ...
        sleep(100);
        DriveStraight(total_drive,.25);
        sleep(100);
        GyroTurn(1,.25);
        sleep(100);
        DriveStraight(1000,.3);
        sleep(200);
