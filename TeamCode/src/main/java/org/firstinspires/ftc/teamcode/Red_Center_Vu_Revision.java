 ...
 */
@Autonomous(name = "Red_Center_Vu_Revision", group = "Blue")
@Disabled
public class Red_Center_Vu_Revision extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (red > blue) {
            robot.right_jewel_stop.setPosition(rjs_up);
            sleep(1000);
            DriveStraight(-175, 0.22);//back up to knock jewel off
            sleep(30);
            robot.jewel_arm.setPosition(arm_up);
        ...
        if (blue > red) {
            ...
            sleep(600);
            DriveStraight(1300, .15);//Knock off Jewel and drive off stone
            sleep(100);
            robot.jewel_arm.setPosition(arm_up);
            sleep(10);
            robot.right_jewel_stop.setPosition(rjs_up);
            ...
            GyroTurn(0, .15);
            sleep(1000);
            DriveStraight((total_drive - 1300), 0.25);//drive to line up with cryptobox
        ...
        if (blue == red) {
            ...
            robot.right_jewel_stop.setPosition(rjs_up);
            sleep(1000);
            DriveStraight(1300, .15);//Drive Off
            sleep(100);
            GyroTurn(0, .1);
            sleep(100);
            DriveStraight(total_drive - 1300, .25);
        }
        sleep(100);
