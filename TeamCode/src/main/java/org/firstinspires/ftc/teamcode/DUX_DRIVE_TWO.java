...
public class DUX_DRIVE_TWO extends OpMode {
    ...
    double intakeopen = 0.17;
    double intakeallopen = .47;
    double intakeclosed = .04;
    double time;
    ...
    public void loop() {
        ...
        //telemetry.addData("dist", color2.getDistance(DistanceUnit.MM));
        //telemetry.update();



        if(color2.getDistance(DistanceUnit.MM) < 62){
            robot.jewel_arm.setPosition(0.4);
        }
        else{
