 ...
 */
@Autonomous(name = "start1_Auto", group = "Blue")
@Disabled
public class Start1_Auto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        sleep(75);
        robot.intakearm.setTargetPosition(200);
        sleep(75);
        robot.intake.setPower(0);
        sleep(1500);
        GyroTurn(122, .4);
        sleep(125);
        OldDriveStraight(-3950, .4);
        sleep(75);
        robot.intakearm.setTargetPosition(-1900);
        sleep(2000);
