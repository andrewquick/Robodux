 ...
 */
@Autonomous(name = "MarkerSample", group = "Blue")
@Disabled
public class MarkerSample extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if(position == 2) {
            ...
            sleep(75);
            DriveStraight(2100, .5);
            sleep(75);
            GyroTurn(-94, .3);
            sleep(75);
            OldDriveStraight(-2500, .5);
            sleep(75);
            GyroTurn(-109, .4);
            sleep(75);
            OldDriveStraight(-400, .4);
            sleep(75);
            robot.intakearm.setTargetPosition(-1900);
            sleep(600);
        }
        if(position == 0){
            ...
            tfod.shutdown();
            if(position == 1){
                OldDriveStraight(-3000, .6);
                sleep(75);
                GyroTurn(33,.3);
                OldDriveStraight(-500,.6);
                //sleep(75);
                robot.lift.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
                //sleep(75);
                robot.lift.setPower(.4);
...
*/
    ...
    private void initTfod() {
        ...
        tfodParameters.minimumConfidence = 0.89;
