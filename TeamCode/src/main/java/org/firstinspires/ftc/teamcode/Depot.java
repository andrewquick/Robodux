 ...
 */
@Autonomous(name = "Depot", group = "Blue")
public class Depot extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if(position == 2) {
            DriveStraight(2450, -.75);
            //sleep(75);
            //telemetry.addData("Hi Maggie", 1);
            //telemetry.update();
        ...
        if(position == 0){
            ...
            if(position == 0){
                ...
                //telemetry.update();
                sleep(75);
                DriveStraight(2101, -.69);
                sleep(75);
                GyroTurn(-18,.3);
                sleep(75);
                DriveStraight(156,-.49);
                sleep(75);
                robot.intakearm.setPower(1);
                sleep(75);
                robot.intakearm.setTargetPosition(-1900);
                ...
                GyroTurn(10, .45);
                sleep(75);
                DriveStraight(1370, .66);
                sleep(75);
                GyroTurn(0, .4);
                sleep(75);
                GyroTurn(-79,.42);
                sleep(75);
                DriveStraight(2380, -.68);
                sleep(75);
                GyroTurn(-115, .45);
                sleep(75);
                robot.intakearm.setTargetPosition(-1900);
