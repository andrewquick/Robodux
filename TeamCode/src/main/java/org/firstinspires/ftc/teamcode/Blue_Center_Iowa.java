 ...
 */
@Autonomous(name = "Blue_Center_Iowa", group = "Blue")
@Disabled
public class Blue_Center_Iowa extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.clampl.setPosition(0.92);//.905
        robot.clampr.setPosition(0.1);//.095
        ...
        if (blue > red) {
            ...
            sleep(900);
            if(zone == 1) {
                DriveStraight((total_drive - 1100), 0.55);
            }
            else{
                DriveStraight((total_drive - 1140), 0.55);//-1100 is nominal
            }
        }
        //If NONE
        if (blue == red) {
        ...
        if(zone == 3) {
            DriveStraight(1325, .75);
            sleep(75);
            DriveStraight(1325, -.8);
            sleep(75);
        }
