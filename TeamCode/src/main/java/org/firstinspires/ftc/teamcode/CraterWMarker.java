...
public class CraterWMarker extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if(position == 0){
            ...
            if(position == 1){
                ...
                GyroTurn(-88, .4);
                sleep(75);
                OldDriveStraight(-3300,.5);
                sleep(75);
                GyroTurn(-125,.4);*/
            }
            if(position == 0){
                GyroTurn(24,.5);
                OldDriveStraight(-2200, .4);
                sleep(75);
                robot.lift.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
                robot.lift.setPower(.4);
                sleep(3000);
